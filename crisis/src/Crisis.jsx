...
const Crisis = () => {
  return (
    <div className="w-full  bg-green-300 p-10">
      <h2 className="text-center text-4xl font-bold text-white py-5">
        Recent Crisis.......
      </h2>
      <div className="w-full flex  justify-center">
        <div className="max-w-sm rounded mx-5 overflow-hidden shadow-lg bg-blue-300 transform hover:scale-1.2 transition-transform">
          <img
        ...
        <div className="max-w-sm mx-5 rounded overflow-hidden shadow-lg bg-blue-300 transform hover:scale-120 transition-transform">
          <img
            className="w-full p-4 border-3"
